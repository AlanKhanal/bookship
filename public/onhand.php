...
$msg="";
    ...
    if(isset($_REQUEST['cancelBuy'])){
        header("location:purchaseCancel.php?trsid=$uqid");
    }
    
    if(isset($_REQUEST['confirm'])){
        header("location:purchaseConfirm.php?trsid=$uqid");
        // echo "Confirm";
    }
...
<body>
    <div align="center" class="purchase">
        <h2>CONFIRM PURCHASE</h2>
            ...
            <form action="" method="POST">
                <input type="submit" name="confirm" value="CONFIRM" class="conf"><br>
            </form>
